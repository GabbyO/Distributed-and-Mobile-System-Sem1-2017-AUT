<%-- 
    Document   : Jointables
    Created on : 21-Apr-2017, 20:25:02
    Author     : Gabby
--%>
...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="style.css">
        <% 
            ...
            ResultSet resultset = 
                statement.executeQuery("select * from members, usertable") ; 
        %>

        <table border="2" width="700px" align="center">
            <tr bgcolor="#cccccc">
                <td colspan=8 align="center" bgcolor= "#c7ded8">
                    <h1><b>Full Two Tables Database Records</b></h1>
                </td>
            </tr>
